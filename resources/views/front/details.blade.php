    ...
    <body class="font-[Poppins]">
        ...
        <section id="Article-container" class="max-w-[1130px] mx-auto flex gap-20 mt-[50px]">
            ...
            <div class="side-bar flex flex-col w-[300px] shrink-0 gap-10">
                        ...
                        <a href="{{ route('front.details', $itemNews->slug) }}" class="card-from-author">
                            <div
                                ...
                                <div class="flex flex-col gap-[6px]">
                                    <p class="line-clamp-2 font-bold">{{ substr($itemNews->name), 0 ,50 }}{{ strlen($itemNews->name) > 50 ? '...' : '' }}</p>
                                    <p class="text-xs leading-[18px] text-[#A3A6AE] uppercase">{{ $itemNews->created_at->format('M d, Y') }} • {{ $itemNews->category->name }}</p>
                                </div>
                            </div>
                        </a>
                    @empty
                ...
                <div class="ads flex flex-col gap-3 w-full">
                    @if (optional($squareAds2)->link || optional($squareAds2)->thumbnail)
